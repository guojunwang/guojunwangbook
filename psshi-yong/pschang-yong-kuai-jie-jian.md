...
11. Shift+f7-选择→反选
12. ctrl+d-取消选定区域
13. 重新选择 【Ctrl】+【Shift】+【D】
14. ctrl+Q-退出PHOTOSHOP
15. 新建图形文件 【Ctrl】+【N】  
16. 新建图层【Ctrl】+【Shift】+【N】  
17. ctrl+w-关闭文件
18. 打开已有的图像 【Ctrl】+【O】
19. 恢复默认前景色（黑）和背景色（白） 【D】
20. 切换前景色和背景色 【X】
21. 显示/隐藏标尺 【Ctrl】+【R】
22. 参考线：从标尺位置拖出来即可
23. 移动工具 【V】
24. 矩形、椭圆选框工具 【M】 
25. 吸管、颜色取样器、标尺、注释工具 【I】
26. 文字工具 【T】  
27. 缩放工具 【Z】，alt变成缩小镜
28. 标准屏幕模式、带有菜单栏的全屏模式、全屏模式 【F】
29. 按Tab键可以显示或隐藏工具箱和调色板
30. 复制选区(多种，这里介绍一种)：选中复制的选区-->选择移动工具-->按住Alt键不放-->在选区中点击鼠标左键不放拖动便可以复制ps选区了
...
15.按alt+backspace(delete)键可将前景色填入选取框按 ctrl+backspace(delete)键可将背景色填入选取框。  
